...
function makeHtmlBoard() {
  ...
  // column-top is a clickable area to add a game piece to that column
...
function checkForWin() {
  ...
  // these four arrays contain the four lines of possible wins
  for (let y = 0; y < HEIGHT; y++) {
    for (let x = 0; x < WIDTH; x++) {
      ...
      // checks if there is a win across any of the four lines
